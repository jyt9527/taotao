...
var TT = TAOTAO = {
	...
	kingEditorParams : {
		// 指定上传文件参数名称
		filePostName  : "uploadFile", // 相当于form的input type="file"
										// name="uploadFile"
		// 指定上传文件请求的url。
        			...
        			editor.plugin.multiImageDialog({
						...
						clickFn : function(urlList) {
							...
							KindEditor.each(urlList, function(i, data) {
								...
								// 回显图片
								// form.find(".pics ul") 获取元素对象 class为.pics
								// 下的ul的标签对象：<div class="pics"><ul></ul></div>
								form.find(".pics ul").append("<li><a href='"+data.url+"' target='_blank'><img src='"+data.url+"' width='80' height='50' /></a></li>");
							});
							// 从表单中获取image标签所在的元素
							// imgArray.join(",") 将数组进行转成字符串
							// 而且是以逗号分隔：比如：a.jpg,b.jpg,c.jpg
							// 将图片的地址 设置到image标签中
