...
<body>
	<div class="w" id="logo">
		<div>
			<a href="http://localhost:8082"> <img
				src="/images/taotao-logo.gif" alt="淘淘商城" width="170" height="60" />
			</a> <b></b>
		</div>
	</div>
	...
	<div class="w" id="regist">
		<div class="mt">
			...
			<div class="extra">
				<span>我已经注册，现在就&nbsp; <a href="/page/login" class="flk13">登录</a>
				</span>
			</div>
		</div>
		<div class="mc">
						...
						<div class="fl item-ifo">
							<input type="checkbox" class="checkbox" checked="checked"
								...
								for="protocol">我已阅读并同意<a href="#" class="blue"
									id="protocol">《淘淘用户注册协议》</a></label> <span class="clr"></span> <label
