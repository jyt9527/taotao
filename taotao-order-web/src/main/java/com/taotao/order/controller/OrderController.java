...
public class OrderController {
	 ...
	 * 
	 *               参数：没有参数，但需要用户的id 从cookie中获取token调用SSO的服务获取用户的ID
	 * 
	 *               返回值：逻辑视图 （订单的确认页面）
	 * 
	 * @param request
...
//		}
	...
	public String createOrder(HttpServletRequest request, OrderInfo info) {
		...
		DateTime plusDays = dateTime.plusDays(3);// 预计到达时间，加3天
