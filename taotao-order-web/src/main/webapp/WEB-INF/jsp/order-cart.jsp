...
<body id="mainframe">
	...
	<form id="orderForm" class="hide" action="/order/create.html"
		...
		<input type="hidden" name="orderShipping.receiverMobile"
			value="15895888888" /> <input type="hidden"
			name="orderShipping.receiverState" value="浙江" /> <input
			type="hidden" name="orderShipping.receiverCity" value="杭州" /> <input
			type="hidden" name="orderShipping.receiverDistrict" value="滨江区" /> <input
			type="hidden" name="orderShipping.receiverAddress" value="网商路699号" />
	</form>
